...
export const AnswerButton = ({ option, idx, onClick }: AnswerButtonProps) => {
  return (
    <button
      type="button"
      key={option}
      className="h-full min-h-12 text-xl flex justify-start items-center group min-w-0 overflow-hidden cursor-pointer"
      onClick={onClick}
    >
      ...
      <span className="border border-l-0 border-primary h-full w-full px-1 flex items-center justify-center rounded-r-lg group-hover:bg-primary/80 transition-colors">
